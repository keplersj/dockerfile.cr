...
describe Dockerfile::Parser do
  describe "parsing the example file" do
    dockerfile = Dockerfile::Parser.from_file("#{__DIR__}/fixture/Dockerfile.example")
  ...
  describe "parsing an empty Dockerfile" do
    dockerfile = Dockerfile::Parser.from_file("#{__DIR__}/fixture/Dockerfile.empty")
  ...
  describe "parsing nginx example" do
    dockerfile = Dockerfile::Parser.from_file("#{__DIR__}/fixture/Dockerfile.nginx_example")
  ...
  describe "parsing Firefox over VNC example" do
    dockerfile = Dockerfile::Parser.from_file("#{__DIR__}/fixture/Dockerfile.firefox_over_vnc_example")
  ...
  describe "parsing multiple images example" do
    dockerfile = Dockerfile::Parser.from_file("#{__DIR__}/fixture/Dockerfile.multiple_images_example")
